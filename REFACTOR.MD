...
- **Application Layer**: `Application` class delegates to runtime, exposing only minimal setup helpers for backwards compatibility. Most logic moves out (transports, job runner, commands).
