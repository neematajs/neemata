...
import type { WsSessionHeartbeatOptions } from '../../../src/ws/session.ts'
import { WsSessionEngine } from '../../../src/ws/session.ts'
 ...
 */
export class StreamTestFormat extends BaseServerFormat {
...
export async function createEngineHarness(options?: {
  ...
  const format = new StreamTestFormat()
