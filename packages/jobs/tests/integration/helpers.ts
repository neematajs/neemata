...
import type { JobsClientInstance } from '../../src/client.ts'

export type JobsServiceTarget = {
  name: string
  url: string | undefined
  createClient: () => JobsClientInstance
}

export const serviceTargets: JobsServiceTarget[] = [
  {
    name: 'Redis',
...
export function requireServiceEnv(target: JobsServiceTarget) {
...
function envName(target: JobsServiceTarget) {
