...
describe('Simple type', () => {
  const schema = t.object({
    ...
    prop5: t.integer(),
    prop6: t.literal('a'),
    prop7: t.enumeration(['a', 'b', 'c'] as const),
    prop8: t.enumeration({
      a: 'A',
      b: 'B',
      c: 'C',
...
describe('Simple type with defaults', () => {
  const schema = t.object({
    ...
    prop7: t.enumeration(['a', 'b', 'c'] as const).default('a'),
    prop8: t
      .enumeration({
        a: 'A',
        b: 'B',
...
describe('Complex type', () => {
  const schema = t.object({
    ...
    prop5: t.object({
      prop1: t.string(),
      prop2: t.integer(),
      prop3: t.enumeration(['a', 'b', 'c'] as const),
      prop4: t.enumeration({
        a: 'A',
        b: 'B',
        c: 'C',
    ...
    prop9: t.object.partial(t.object({ prop1: t.string(), prop2: t.number() })),
    prop10: t.object.pick(t.object({ prop1: t.string(), prop2: t.number() }), {
      prop1: true,
    }),
    prop11: t.object.keyof(t.object({ prop1: t.string(), prop2: t.number() })),
    prop12: t.or(
      t.object({ prop1: t.string() }),
      t.object({ prop2: t.number() }),
    ),
