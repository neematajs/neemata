...
/**
 * Factory function type for creating server instances.
 */
export type ServerFactory = () =>
  | ServerLifecycleTarget
  | Promise<ServerLifecycleTarget>
...
export class ServerLifecycle extends EventEmitter<LifecycleEvents> {
  ...
  private server: ServerLifecycleTarget | null = null
  ...
  getServer(): ServerLifecycleTarget | null {
    return this.server
  }
