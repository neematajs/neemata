...
import type { EncodeRPCContext } from '../../src/client/index.ts'
import type { DecodeRPCContext } from '../../src/common/index.ts'
import { ProtocolError } from '../../src/client/index.ts'
import { ProtocolBlob } from '../../src/common/index.ts'
import { MsgpackCodec } from '../../src/msgpack/client.ts'
  ...
  describe('Client', () => {
    ...
    describe('decode', () => {
      ...
      it('should decode empty buffer to undefined', () => {
        expect(codec.decode(new Uint8Array(0))).toBeUndefined()
      })
    ...
    describe('encodeRPC', () => {
      it('should encode RPC without streams', () => {
        ...
        const buffer = codec.encodeRPC(payload, encodeCtx)

        const decodeCtx = { addStream: vi.fn() } as DecodeRPCContext<any>
        const decoded = codec.decodeRPC(buffer, decodeCtx)
      ...
      it('should encode RPC with multiple streams', () => {
        ...
        const decoded = codec.decodeRPC(buffer, decodeCtx) as any
    ...
    describe('decodeRPC', () => {
      it('should decode RPC without streams', () => {
        ...
        const encodeCtx: EncodeRPCContext = { addStream: vi.fn() }
        const encoded = codec.encodeRPC(payload, encodeCtx)

        const decodeCtx = { addStream: vi.fn() } as DecodeRPCContext<any>
        const decoded = codec.decodeRPC(encoded, decodeCtx)
    ...
    describe('undefined value handling', () => {
      it('should encode undefined data in encodeRPC', () => {
        ...
        const buffer = codec.encodeRPC(undefined, encodeCtx)
      ...
      it('should encode null data in encodeRPC', () => {
        ...
        const buffer = codec.encodeRPC(null, encodeCtx)
