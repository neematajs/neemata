...
import { JsonCodec } from '../../src/json/server.ts'

describe('Server JsonCodec', () => {
  ...
  describe('Server', () => {
    ...
    describe('encodeRPC', () => {
      ...
      it('should encode RPC with multiple streams', () => {
        ...
        const payload = {
          file1: ProtocolBlob.from('One', metadata1, () => codec.encodeBlob(0)),
          file2: ProtocolBlob.from('Two', metadata2, () => codec.encodeBlob(1)),
        }
