...
export type RegistryContentType = PrometheusContentType | OpenMetricsContentType
...
export class WorkerRegistry<T extends RegistryContentType> extends Registry<T> {
  /** Creates a registry, optionally coordinating collection from other threads. */
  constructor(regContentType?: T, primary?: boolean)
